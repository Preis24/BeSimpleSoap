                        ...
                        ->prototype('array')
                            ->children()
                                ...
                                ->scalarNode('soap_version')
                                    ->validate()
                                        ->ifNotInArray(array(1.1, 1.2))
                                        ->thenInvalid(sprintf('The SOAP version has to be either: %s', implode(', ', array(1.1, 1.2))))
                                    ->end()
                                ->end()
                                ->arrayNode('auth')
                                    ...
                                    ->beforeNormalization()
                                        ...
                                        ->then(function ($v) { return array('login' => null === $v ? false : $v); })
                                    ->end()
                                    ->children()
                                        ->scalarNode('type')
                                            ->defaultNull()
                                            ->validate()
                                                ->ifNotInArray(array('basic'))
                                                ->thenInvalid(sprintf('The auth type has to be either: %s', implode(', ', array('basic'))))
                                            ->end()
                                        ->end()
                                ...
                                ->arrayNode('ssl')
                                    ...
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('verify_peer')->defaultFalse()->end()
                                        ->scalarNode('verify_host')->defaultFalse()->end()
                                    ->end()
                                ->end()
